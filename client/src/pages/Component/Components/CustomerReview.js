      ...
      <div className="main-review headding" id="Blog">
        <Container>
          ...
          <Row className="customerReview">
                    <Col  md={2} xs={12} >
                      <img className="img-fluid mx-auto img-circle img--size" src={CR1} alt="Review" />
                    </Col>
                  ...
                  <Row className="customerReview">
                    <Col  md={2} xs={12}>
                      <img className="img-fluid mx-auto img-circle  img--size" src={CR2} alt="Review" />
                    </Col>
                  ...
                  <Row className="customerReview">
                    <Col  md={2} xs={12}>
                      <img className="img-fluid mx-auto img-circle  img--size" src={CR3}  alt="Review"/>
                    </Col>
